  ...
  <div class="form-group">
    ...
    <div class="content_area row pt-6 pb-6">
        ...
        <div class="col-sm-8">
          <h2>INSTRUCTIONS</h2>
          <p>
            To get a shareable widget code select a version of a widget and copy the code below. For additional dev tools see <a target="_blank" href="/admin/devtools">HERE</a>
          </p>
